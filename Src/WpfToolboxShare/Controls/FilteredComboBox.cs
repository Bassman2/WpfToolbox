...
// https://gist.github.com/glebd/392290
public class FilteredComboBox : ComboBox
{
    ...
    public FilteredComboBox()
    {
        ...
        var textProperty = DependencyPropertyDescriptor.FromProperty(TextProperty, typeof(FilteredComboBox));
    ...
    {
        editableTextBox = (TextBox?)GetTemplateChild("PART_EditableTextBox");
        editableTextBox!.SelectionChanged += OnEditableTextBoxSelectionChanged;
    ...
    //    DependencyProperty.Register("IsCaseSensitive", typeof(bool), typeof(FilteredComboBox),
    ...
    //{
    //    DependencyPropertyDescriptor.FromProperty(IsCaseSensitiveProperty, typeof(FilteredComboBox)).AddValueChanged(this, OnIsCaseSensitiveChanged);
    //}
    ...
    //    DependencyProperty.Register("DropDownOnFocus", typeof(bool), typeof(FilteredComboBox),
        ...
        KeyboardFocusChangedEventArgs e)
    {
        ...
        {
            _savedText = GetSelectedValue()?.ToString() ?? "";
        }
    ...
    {
        Debug.WriteLine($"Filtering item: {value} with text <{Text}>");
        ...
        return value.ToString()!.StartsWith(prefix, StringComparison.InvariantCultureIgnoreCase);
            //!IsCaseSensitive, CultureInfo.CurrentCulture); 
        //return value.ToString()!.Contains(prefix, StringComparison.InvariantCultureIgnoreCase);
    }
    ...
    private object? GetSelectedValue()
    {
        ...
        PropertyInfo? prop = SelectedItem?.GetType().GetProperty(DisplayMemberPath);
